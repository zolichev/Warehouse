...
Связку между контроллерами и сервисами сделать через инжектор вместо временной связки с ServiceManager.
...
Не реализован UI приложения. В текущей архитектуре допускает реализацию UI как веб приложения, дестопного, мобильного и многих других типов приложений.